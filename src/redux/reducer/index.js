...
const initialState = {
  ...
  admin: { content: "leonardo" }, // inutilizzato, serve come esempio di proprietà esterana a cart che viene mantenuta anche dopo il cambio di stato
};
